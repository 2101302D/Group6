			...
			<div class="card" style="background-color:#bababa;">
				<div class="card-body">
					...
					<table style="width:100%; height:auto;">
						<tr>
							<td style="font-size: 12px; background-color:#d4d4d4; width: 350px; padding-left: 20px; padding-bottom: 10px">
							...
							<td>
								<img style="width:550px; height:250px " alt="" src="https://uploads-ssl.webflow.com/612ca8920bc3a648125ffac3/623207cf3b77e02a8e6a1564_Wooting-two-HE-min.png">
							</td>
						</tr>
					</table>
				</div>
				...
				<div class="card-body">
					...
					<table style="width:100%; height:auto;">
						<tr>
							...
							<td style="padding-left: 60px;"></td>
							<td>
								<img style="width:550px; height:250px" alt="" src="https://mountain.gg/assets/Mountain-Everest-Max-Gunmetal-Gray-45-RGB.png">
							</td>
						</tr>
					</table>
				</div>
				...
				<div class="card-body">
					...
					<table style="width:100%; height:auto;">
						<tr>
							...
							<td style="padding-left: 60px;"></td>
							<td>
								<img style="width:550px; height:250px" alt="" src="https://i.ebayimg.com/images/g/G5oAAOSwq5tix49L/s-l500.jpg">
							</td>
						</tr>
					</table>
				</div>
